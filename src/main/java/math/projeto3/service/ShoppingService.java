...
public class ShoppingService {
    ...
    private static void updateQuantityRemove(UpdateItemShoppingDTO updateItemShoppingDTO, Map<Long, ShoppingProductModel> productMap, ShoppingModel shoppingModel, ProductsModel productsModel) {

        // Reduzir o valor da quantidade
        ShoppingProductModel modifyProduct = productMap.get(updateItemShoppingDTO.idProduct());
        modifyProduct.setQuantity(modifyProduct.getQuantity() - updateItemShoppingDTO.quantity());
